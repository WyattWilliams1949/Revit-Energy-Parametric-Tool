...
public class MatlabModeCommand : IExternalCommand
{
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        Document doc = commandData.Application.ActiveUIDocument.Document;

        // Harvest Elements like we do for the regular UI
        ...
        MatlabServer server = new MatlabServer(doc, activeEnvelopeTypes, handler, exEvent);
        
        MatlabModeWindow matlabWindow = new MatlabModeWindow(server);
        matlabWindow.Show();
